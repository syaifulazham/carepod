    ...
    return(
        <div className="flex flex-col pt-10 pr-10 pb-5">
            <div className="flex flex-col text-gray-500 gap-3">
                <div className={`${currentStage === 'welcome' ? 'flex flex-row gap-4 border-b border-blue-500' : 'flex flex-row gap-4'}`}>
                ...
                <div className={`${currentStage === 'profile' ? 'flex flex-row gap-4 border-b border-blue-500' : 'flex flex-row gap-4'}`}>
                ...
                <div className={`${currentStage === 'additional' ? 'flex flex-row gap-4 border-b border-blue-500' : 'flex flex-row gap-4'}`}>
                ...
                <div className={`${currentStage === 'diagnosis' ? 'flex flex-row gap-4 border-b border-blue-500' : 'flex flex-row gap-4'}`}>
                ...
                <div className={`${currentStage === 'self-check' ? 'flex flex-row gap-4 border-b border-blue-500' : 'flex flex-row gap-4'}`}>
